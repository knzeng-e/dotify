...
- Branch / PR / issue: `feat/royalty-failure-isolation`; PR pending; issue #145.
...
- Project/metadata updates completed and any inaccessible fields: issue #145
  created and mapped in `docs/backlog/backlog.json` and `sequence.json`. PR and
  Project 5 fields still need to be completed after the draft PR exists.
