...
- Branch / PR / issue: `fix/player-support-clarity`; PR pending at first evidence commit; issue #178.
...
- Project/metadata updates: pending PR creation; issue #178 remains the source ticket.
