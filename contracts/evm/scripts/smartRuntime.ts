...
function renderDeploymentsTs(data: SmartRuntimeDeployments): string {
  return `// AUTO-GENERATED by contracts/evm/scripts/deploy.ts — do not edit manually
export const deployments = {
  factory: '${data.factory}',
  directory: '${data.directory}',
  initializer: '${data.initializer}',
  pallets: {
    cutPallet: '${data.pallets.cutPallet}',
    loupePallet: '${data.pallets.loupePallet}',
    ownershipPallet: '${data.pallets.ownershipPallet}',
    registryPallet: '${data.pallets.registryPallet}',
    nftPallet: '${data.pallets.nftPallet}',
    royaltiesPallet: '${data.pallets.royaltiesPallet}',
    accessPallet: '${data.pallets.accessPallet}'
  }
} as const;
...
export function writeDeployments(data: SmartRuntimeDeployments) {
  ...
  fs.writeFileSync(DEPLOYMENTS_TS, renderDeploymentsTs(data));
