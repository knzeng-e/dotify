...
export default defineConfig({
  ...
  grep: /catalog row|catalog journey|room arrival|composer remains above|tapped tab|focus waits|keyboard restores|player essentials|design review surfaces/,
