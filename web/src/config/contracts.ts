...
export const artistDirectoryAbi = [
  ...
  {
    type: 'function', name: 'artistsPage',
    inputs: [{ name: 'offset', type: 'uint256' }, { name: 'limit', type: 'uint256' }],
    outputs: [{ name: 'artists', type: 'address[]' }, { name: 'runtimes', type: 'address[]' }],
    stateMutability: 'view'
  },
  { type: 'function', name: 'factory', inputs: [], outputs: [{ name: '', type: 'address' }], stateMutability: 'view' },
  {
    type: 'event', name: 'ArtistRegistered',
    inputs: [{ name: 'artist', type: 'address', indexed: true }, { name: 'runtime', type: 'address', indexed: true }]
  }
] as const;
...
export const artistRuntimeFactoryAbi = [
  ...
  {
    type: 'event', name: 'ArtistRuntimeCreated',
    inputs: [{ name: 'artist', type: 'address', indexed: true }, { name: 'runtime', type: 'address', indexed: true }]
  }
] as const;
...
export const musicRegistryAbi = [
  {
    type: 'function', name: 'musicRegRegister',
    inputs: [
      {
        name: 'reg', type: 'tuple',
        components: [
  ...
  {
    type: 'function', name: 'musicRegDeactivate',
    inputs: [{ name: 'contentHash', type: 'bytes32' }],
    outputs: [],
    stateMutability: 'nonpayable'
  },
  {
    type: 'function', name: 'musicRegGetTrack',
    inputs: [{ name: 'contentHash', type: 'bytes32' }],
    outputs: [
      {
        name: 'track', type: 'tuple',
        components: [
  ...
  { type: 'function', name: 'musicRegIsRegistered',   inputs: [{ name: 'contentHash', type: 'bytes32' }], outputs: [{ name: '', type: 'bool' }],    stateMutability: 'view' },
  { type: 'function', name: 'musicRegIsActive',       inputs: [{ name: 'contentHash', type: 'bytes32' }], outputs: [{ name: '', type: 'bool' }],    stateMutability: 'view' },
  { type: 'function', name: 'musicRegTrackCount',     inputs: [],                                         outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'musicRegTrackHashAtIndex',inputs: [{ name: 'index', type: 'uint256' }],      outputs: [{ name: '', type: 'bytes32' }], stateMutability: 'view' },
  {
...
export const musicRoyaltiesAbi = [
  ...
  { type: 'function', name: 'musicRoySplitCount',   inputs: [{ name: 'contentHash', type: 'bytes32' }], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  {
    type: 'function', name: 'musicRoySplitAt',
    inputs: [{ name: 'contentHash', type: 'bytes32' }, { name: 'index', type: 'uint256' }],
    outputs: [{ name: 'recipient', type: 'address' }, { name: 'bps', type: 'uint16' }],
    stateMutability: 'view'
  },
  { type: 'function', name: 'musicRoyTotalBps', inputs: [{ name: 'contentHash', type: 'bytes32' }], outputs: [{ name: '', type: 'uint16' }], stateMutability: 'view' },
  {
    type: 'event', name: 'MusicRoyAccessPaid',
    inputs: [{ name: 'contentHash', type: 'bytes32', indexed: true }, { name: 'listener', type: 'address', indexed: true }, { name: 'amount', type: 'uint256', indexed: false }]
  }
] as const;
...
export const musicAccessAbi = [
  ...
  { type: 'function', name: 'musicAccSetPersonhoodLevel',inputs: [{ name: 'account', type: 'address' }, { name: 'level', type: 'uint8' }], outputs: [], stateMutability: 'nonpayable' },
  { type: 'function', name: 'musicAccCanAccess',         inputs: [{ name: 'contentHash', type: 'bytes32' }, { name: 'listener', type: 'address' }], outputs: [{ name: '', type: 'bool' }],    stateMutability: 'view' },
  { type: 'function', name: 'musicAccHasPaid',           inputs: [{ name: 'contentHash', type: 'bytes32' }, { name: 'listener', type: 'address' }], outputs: [{ name: '', type: 'bool' }],    stateMutability: 'view' },
  { type: 'function', name: 'musicAccPersonhoodLevel',   inputs: [{ name: 'account', type: 'address' }],   outputs: [{ name: '', type: 'uint8' }],  stateMutability: 'view' },
  { type: 'function', name: 'musicAccHasPersonhood',     inputs: [{ name: 'account', type: 'address' }, { name: 'required', type: 'uint8' }], outputs: [{ name: '', type: 'bool' }],    stateMutability: 'view' },
...
export const musicNFTAbi = [
  { type: 'function', name: 'musicNFTTransfer',        inputs: [{ name: 'tokenId', type: 'uint256' }, { name: 'to', type: 'address' }], outputs: [], stateMutability: 'nonpayable' },
  { type: 'function', name: 'musicNFTApprove',         inputs: [{ name: 'to', type: 'address' }, { name: 'tokenId', type: 'uint256' }], outputs: [], stateMutability: 'nonpayable' },
  { type: 'function', name: 'musicNFTSetApprovalForAll',inputs: [{ name: 'operator', type: 'address' }, { name: 'approved', type: 'bool' }], outputs: [], stateMutability: 'nonpayable' },
  { type: 'function', name: 'musicNFTOwnerOf',         inputs: [{ name: 'tokenId', type: 'uint256' }],   outputs: [{ name: '', type: 'address' }], stateMutability: 'view' },
  { type: 'function', name: 'musicNFTBalanceOf',       inputs: [{ name: 'owner', type: 'address' }],     outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'musicNFTGetApproved',     inputs: [{ name: 'tokenId', type: 'uint256' }],   outputs: [{ name: '', type: 'address' }], stateMutability: 'view' },
  { type: 'function', name: 'musicNFTIsApprovedForAll',inputs: [{ name: 'owner', type: 'address' }, { name: 'operator', type: 'address' }], outputs: [{ name: '', type: 'bool' }], stateMutability: 'view' }
] as const;
